    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SampleIndicators", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReferentMax = table.Column<double>(type: "float", nullable: true),
                    ReferentMin = table.Column<double>(type: "float", nullable: true),
